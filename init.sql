...
INSERT INTO "products" ("name","category","price","stock","rating","is_active","tags","description","created_at","owner") VALUES
  ('Pro Laptop X1',     'Electronics', 999.99, 50,  4.5, 1, '["electronics","gadget"]',    'High-end laptop with 16GB RAM',   '2025-06-15T10:00:00Z', 1),
...
INSERT INTO "logs" ("level","module","message","ip","ua","duration_ms","created_at") VALUES
  ('INFO',  'auth',       'User admin logged in',          '192.168.1.10',  'Chrome/120.0', 12,   '2025-06-01T08:00:00Z'),
